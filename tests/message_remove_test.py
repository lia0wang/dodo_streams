...
def test_msg_rm_invalid_msg_id():
    ...
    print(channel_list1['channels'])
    channel_list2 = channels_list_v1(u_id1)
    print(channel_list2['channels'])

    invalid_msg_id_1 = message_send_v1(token1, channel1['channel_id'], msg)
    invalid_msg_id_2 = message_send_v1(token2, channel3['channel_id'], msg)
    print(invalid_msg_id_1)
    print(invalid_msg_id_2)
