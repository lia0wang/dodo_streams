...
def test_share_basic_dm_http():
    ...
    assert message_share.status_code == 200

def test_share_basic_channel_http():
    requests.delete(f"{BASE_URL}/clear/v1", json = {})
...
def test_share_not_channel_message_http():
    requests.delete(f"{BASE_URL}/clear/v1", json = {})
