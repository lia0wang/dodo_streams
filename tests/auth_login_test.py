...
def test_valid_login():
    ...
    u_id = auth_register_v1("JoJo@gmail.com", "HermitPurple", "Joseph", "Joestar")
    u_id2 = auth_register_v1("testA@gmail.com", "testA2021", "John", "smith")
    u_id3 = auth_register_v1("StandUser@gmail.com", "StandPower", "Generic", "name")
    u_id4 = auth_register_v1("11037.666@gmail.com", "armStrongCann0n", "Isaac", "Schneider")
